...
dosya_bilgiler <- tibble(
  ...
  "Kısmi_Odeme_Sayısı" = 0,
  "Kısmi_Odeme_Tarihi_1" = as.Date(NA),
  "Kısmi_Odeme_Tutarı_1" = 0,
  "Kısmi_Odeme_Tarihi_2" = as.Date(NA),
  "Kısmi_Odeme_Tutarı_2" = 0,
  "Bakıcı_Gideri_Süresi_(gun)" = 0
)

ortak_data_list2 <- list(data = dosya_bilgiler, 
                        yasam_tablosu = Yasam_Tablosu)

ortak_veri_tbl <- ortak_veri_tablosu(ortak_data_list2$data, ortak_data_list2$yasam_tablosu)
...
knitr::kable(ortak_veri_tbl$parametre_tablosu, caption = "HESAPLAMA PARAMETRELERİ")
...
knitr::kable(HT_Tam_Maluliyet_Donemi_Tablosu(ortak_veri_tbl), caption = "Hesap Tarihi - Geçici Maluliyet Tablosu")

gecici_donem_tazminat <- sum(HT_Tam_Maluliyet_Donemi_Tablosu(ortak_veri_tbl)$Donem_Tazminat)

str_glue("{ortak_veri_tbl$Gecici_Maluliyet_sure} aylık Geçici İş Göremezlik Tazminatı {gecici_donem_tazminat} TL olarak hesaplanmıştır.")
...
str_glue("* {ortak_veri_tbl$Gecici_Maluliyet_sure} aylık Geçici İş Göremezlik Tazminatı {kalan_tazminat} TL olarak hesaplanmıştır.")
