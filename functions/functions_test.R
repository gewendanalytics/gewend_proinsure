...
## Sonuç 
ortak_veri_tbl <- ortak_veri_tablosu(ortak_data_list$data, ortak_data_list$yasam_tablosu)
ortak_veri_tbl 
...
HT_Tam_Maluliyet_Donemi_Tablosu(ortak_veri_tbl)
...
HT_Maluliyet_Sonrasi_Donem_Tablosu(ortak_veri_tbl)
...
HT_Bilinmeyen_Donem_Tablosu(ortak_veri_tbl)
...
toplam_tazminat_func(ortak_veri_tbl)
...
Bakiye_Tazminat(ortak_veri_tbl)
...
bakici_gideri_func(ortak_veri_tbl)
...
SOT_Tam_Maluliyet_Donemi_Tablosu(ortak_veri_tbl)
...
SOT_Maluliyet_Sonrasi_Donem_Tablosu(ortak_veri_tbl)
...
SOT_Bilinen_Donem_Tablosu(ortak_veri_tbl)
...
SOT_Bilinmeyen_Donem_Tablosu(ortak_veri_tbl)
...
sirket_odeme_hesap_tarih_degeri_hesaplama(ortak_veri_tbl)
...
sirket_odeme_faiz_tablosu(ortak_veri_tbl)
...
sirket_odeme_ht_tutarı(ortak_veri_tbl)
...
teknik_faizli_surekli_tazminat_func(ortak_veri_tbl, 0.1)
...
gecici_tazminat_func(ortak_veri_tbl)$sonuc_tablosu
...
surekli_tazminat_func(ortak_veri_tbl)
...
surekli_gecici_tazminat_func(ortak_veri_tbl)
...
tum_rapor_sirket_odemesiz_func(ortak_veri_tbl)
...
teknik_faiz_surekli_tazminat_func(ortak_veri_tbl, 0.7)
